...
def get_transcripts_info():

    file = 'trans_name-gene_id-gene_name.tsv'
...
def main():
    ...
    kd_res_df.to_csv('NMD_KD_rescue_transcripts.tsv', sep='\t', index=False)
